...
class _SelectprofilepicPageState extends State<SelectprofilepicPage> {
  ...
  uploadImage() {
    ...
    task.then((value) {
      userManagement.updateProfilePic(firebaseStorageRef.getDownloadURL().toString()).then((val) {
                    ...
                    Container(
                        ...
                        child: Material(
                          ...
                          child: GestureDetector(
                            onTap: ()async {
                              newProfilePic = await ImagePicker().getImage(source: ImageSource.gallery) as File;
                            },
                            child: Center(
                              child: Text(
                                'Change Pic',
